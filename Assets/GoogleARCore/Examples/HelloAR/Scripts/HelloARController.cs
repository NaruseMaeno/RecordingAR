...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            if (Physics.Raycast(rayTouch, out hitTouch) && hitTouch.collider.gameObject.tag == "Player") 
            {
                return;
            } 
            else if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit))
            {
